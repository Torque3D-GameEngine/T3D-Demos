...
singleton Material(volcano_tex_volcano_cave_2)
{
	...
	diffuseMap[0] = "./volcano_cave_2_dif";
	normalMap[0] = "./volcano_cave_2_nrm.dds";
	specularMap[0] = "";
...
singleton Material(volcano_tex_volcano_cave_3)
{
	...
	translucent = false;
	translucentBlendOp = "None";
   detailMap[0] = "./rockydirt_detail.dds";
   detailScale[0] = "12 12";
   materialTag0 = "volcano";
};
...
singleton Material(volcano_tex_volcano_cave_1)
{
   ...
   diffuseMap[0] = "./volcano_cave_1_dif.dds";
   detailScale[0] = "6 6";
   specular[0] = "0.9 0.9 0.9 1";
   specularPower[0] = "10";
   translucentBlendOp = "None";
   detailMap[0] = "./volcano_cave_wall_tileable.dds";
   normalMap[0] = "./volcano_cave_1_nrm.dds";
   materialTag0 = "volcano";
};
...
singleton Material(lavaflow_ColorEffectR113G135B6_material)
{
