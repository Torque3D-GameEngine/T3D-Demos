...
{
   diffuseMap[0] = "./thintree_diffuse_transparency.dds";
   normalMap[0] = "./thintree_normal.dds";
   ...
   specularMap[0] = "./thintree_specular.dds";
...
{
   diffuseMap[0] = "./thintree_bark_diffuse.dds";
   normalMap[0] = "./thintree_bark_normal.dds";
   mapTo = "thintree_bark";
