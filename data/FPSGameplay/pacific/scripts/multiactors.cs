...
datablock PxMultiActorData( pxCoveredStructure ) 
{
	...
	shapeName = "data/FPSGameplay/pacific/art/shapes/structures/coveredstructure/coveredstructure.dae";
	physXStream = "data/FPSGameplay/pacific/art/shapes/structures/coveredstructure/coveredstructure.xml";
...
datablock PxMultiActorData( pxPier ) 
{
	...
	shapeName = "data/FPSGameplay/pacific/art/shapes/structures/pier/pier.dae";
	physXStream = "data/FPSGameplay/pacific/art/shapes/structures/pier/pier.xml";
...
datablock PxMultiActorData( pxWatertower ) 
{
	...
	shapeName = "data/FPSGameplay/pacific/art/shapes/structures/pier/watertower.dae";
	physXStream = "data/FPSGameplay/pacific/art/shapes/structures/pier/watertower.xml";
...
datablock LightFlareData( WaterTowerLightFlare )
{
   overallScale = 2.0;
   flareEnabled = true;
   flareTexture = "data/FPSGameplay/pacific/art/lights/lensFlareSheet1";
