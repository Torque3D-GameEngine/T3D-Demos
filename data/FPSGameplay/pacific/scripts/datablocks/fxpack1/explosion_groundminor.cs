...
{
filename = "data/FPSGameplay/pacific/sound/grenade_explosion";
...
{
   textureName          = "data/FPSGameplay/pacific/art/particles/dirtblast02";
   dragCoefficient      = 5;
...
{
   textureName          = "data/FPSGameplay/pacific/art/particles/dirtblast01";
   dragCoefficient      = 5;
   gravityCoefficient   = 0.0;
   inheritedVelFactor   = 0.2;
   windCoefficient      = 0;
...
{
   textureName          = "data/FPSGameplay/pacific/art/particles/rocks";
...
{
   textureName          = "data/FPSGameplay/pacific/art/particles/dirt";
   dragCoeffiecient     = 0.0;
...
{
   textureName          = "data/FPSGameplay/pacific/art/particles/smoke01";
   dragCoeffiecient     = 0.0;
